...
or scenario. Put every required fact that is absent in missing_fields.
...
Replan and impact require goal_id. Impact also requires proposed_spend_sen.
Scenario selection requires goal_id and either scenario_id or scenario_label.

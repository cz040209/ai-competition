...
COMPOSE_INSTRUCTION = """Write the reply now.

If figures are listed above, use them exactly. Two paragraphs at most: the first is one
sentence containing the number that answers the question, the second is the short reason
behind it. Do not list the evidence — the interface shows it.

If no figures are listed, this turn is conversation rather than a calculation. Reply in
one or two plain, warm sentences. State no amount, and say nothing about tools, figures
or why nothing was looked up."""
